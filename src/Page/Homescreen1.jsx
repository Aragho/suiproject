...
const Homescreen1 = () => {
  ...
  <div className="flex items-center gap-3">
    ...
    <div>
      ...
      <Link to="home2"><h3 className="text-sm lg:text-lg font-light">
...
<div className="text-white mt-6">
  ...
  <div className="flex items-center justify-between">
    <h1 className="text-2xl lg:text-4xl font-bold">₦0.00</h1>
    <button
...
<p className="mt-6 text-[#3A3C4C] font-semibold text-lg">
 ...
 <div className="flex items-center mt-3 gap-4">
   ...
   <p className="text-[#7D7C93] text-[13.5px] md:text-[25px]">You haven't made any transactions yet</p>
 </div>
